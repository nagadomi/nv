 ...
 * @return always 127
 */
MT_INLINE static int tinymt32_get_mexp(
    tinymt32_t * random  __attribute__((unused))) {
    return TINYMT32_MEXP;
}
#else
MT_INLINE static int tinymt32_get_mexp(tinymt32_t * random) {
    return TINYMT32_MEXP;
}
#endif
 ...
 */
MT_INLINE static void tinymt32_next_state(tinymt32_t * random) {
    uint32_t x;
    uint32_t y;
 ...
 */
MT_INLINE static uint32_t tinymt32_temper(tinymt32_t * random) {
    uint32_t t0, t1;
    t0 = random->status[3];
 ...
 */
MT_INLINE static float tinymt32_temper_conv(tinymt32_t * random) {
    uint32_t t0, t1;
    union {
		uint32_t u;
		float f;
 ...
 * @return floating point number r (1.0 < r < 2.0)
 */
MT_INLINE static float tinymt32_temper_conv_open(tinymt32_t * random) {
    uint32_t t0, t1;
    union {
		uint32_t u;
		float f;
